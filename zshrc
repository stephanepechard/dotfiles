...
alias grep='grep --color=auto' # -n pour afficher les numéros de ligne
...
# Prompt couleur (la couleur n'est pas la même pour le root et pour les simples utilisateurs)
if [ "`id -u`" -eq 0 ]; then
